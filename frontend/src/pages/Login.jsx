...
export default function Login() {
  ...
  const API_URL = import.meta.env.VITE_API_BASE_URL || "https://edutrack-ai-backend-oouq.onrender.com";
  ...
  return (
    <div className="min-h-screen w-full bg-[#050914] flex items-center justify-center p-4 relative overflow-hidden text-slate-200">
      ...
      <div 
        className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-600/20 rounded-full blur-[120px] pointer-events-none animate-pulse"
